                        ...
                        <div class="recommended-author">
                            <div class="title">
                                ...
                                <nuxt-link class="page-change" to="/">
                                    <button class="fa fa-refresh rote" ></button>
                                    <span @click="swap()">换一批</span>
                                </nuxt-link>
                            </div>
                            <ul class="recommended-list">
                                ...
                                <li>
                                    ...
                                    <a href="#" :class="'follow'" @click="clickleave($event)" >
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            //     e.target.classList.add('rote');
            //     setTimeout(function(){
            //         e.target.classList.remove('rote');
            //     },1000)
